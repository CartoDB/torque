  ...
  function renderPoint(ctx, st) {
    ...
    if (st['marker-fill']) {
      if (st['marker-opacity'] !== undefined || st['marker-fill-opacity'] !== undefined ) {
        ctx.globalAlpha = st['marker-opacity'] >=0 ? st['marker-opacity']: st['marker-fill-opacity'];
      }
    ...
    if (st['marker-line-color'] && st['marker-line-width'] && st['marker-line-width'] > LINEWIDTH_MIN_VALUE) {
      if (st['marker-opacity'] !== undefined || st['marker-line-opacity'] !== undefined) {
        ctx.globalAlpha = st['marker-opacity'] >=0 ? st['marker-opacity']: st['marker-line-opacity'];
      }
