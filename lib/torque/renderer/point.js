(function(exports) {
  ...
  var DEFAULT_CARTOCSS = [
    ...
    '  marker-fill: #662506;',
    '  marker-width: 20;',
    '  point-file: url(https://s3.amazonaws.com/com.cartodb.assets.dev/development/dev/assets/marker-icon-2x.png);',
    '  marker-file: url(https://s3.amazonaws.com/com.cartodb.assets.dev/development/dev/assets/marker-icon-2x.png);',
